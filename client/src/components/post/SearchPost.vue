...
const filteredList = computed(() => {
  ...
  if (!searchValue.value) return posts.value;

  return posts.value.filter((note) =>
...
<template>
  <div>
    <input type="text" v-model="searchValue" placeholder="Search posts..." />
    ...
    <div v-else-if="searchValue !== '' && posts?.length" class="item error">
