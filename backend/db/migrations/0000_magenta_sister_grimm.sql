...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "day_quest_tasks_categories" ADD CONSTRAINT "day_quest_tasks_categories_category_id_day_quest_tasks_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."day_quest_tasks"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
